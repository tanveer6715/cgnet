...
def compute_iou_loss(labels, predictions, num_classes = 5):
...
with mirrored_strategy.scope():
    ...
    # model_weight_path = '/home/soojin/UOS-SSaS Dropbox/05. Data/03. Checkpoints/#cgnet/2021.09.27 ESNet_cityscapes/epoch_325.h5'
...
path =  '/home/soojin/UOS-SSaS Dropbox/05. Data/03. Checkpoints/#cgnet/2021.11.01 cgnetnew_concrete/'
for epoch in tqdm(range(1, EPOCHS + 1)):
    ...
    if epoch % 5 == 0 :
        model.save_weights('/home/soojin/UOS-SSaS Dropbox/05. Data/03. Checkpoints/#cgnet/2021.11.01 cgnetnew_concrete/epoch_{}.h5'.format(epoch))
    if epoch % 10 == 0 :
