...
def DeeplabV3Plus(input_size=(640,640, 3), num_classes=5, depthwise=False, output_stride=16, backbone='modified_xception'):
    ...
    #         weights='imagenet', include_top=False, input_shape=input_size, classes=5)
